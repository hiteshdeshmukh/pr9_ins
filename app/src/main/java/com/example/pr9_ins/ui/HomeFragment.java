...
/*
        storyRecycler = storyRecycler.findViewById(R.id.storyRecycler);
...
/*
        dashboardRecycler = getView().findViewById(R.id.dashboardRecycler);
        dashBoardModelArrayList = new ArrayList<>();

        dashBoardModelArrayList.add(new DashBoardModel(R.drawable.h10, R.drawable.h9,"Hitesh D"));

        DashBoardAdapter dashBoardAdapter = new DashBoardAdapter(dashBoardModelArrayList,getContext());
        LinearLayoutManager layoutManager = new LinearLayoutManager(getContext());
        dashboardRecycler.setLayoutManager(layoutManager);
        dashboardRecycler.setNestedScrollingEnabled(false);
